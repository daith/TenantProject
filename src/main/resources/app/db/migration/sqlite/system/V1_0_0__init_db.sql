...
INSERT INTO `system_data_source` (`name`, `caption`, `display_order`, `status`, `is_deleted`, `database_type`, `driver_class_name`, `url`, `username`, `password`)
...
INSERT INTO `system_config` (`name`, `caption`, `display_order`, `is_default`)
